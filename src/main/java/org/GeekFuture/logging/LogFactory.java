...
public final class LogFactory {
  ...
  public static synchronized void useJdkLogging() {
    setImplementation(org.GeekFuture.logging.jdk14.Jdk14LoggingImpl.class);
  }

  //这个没用到
  public static synchronized void useStdOutLogging() {
    setImplementation(org.GeekFuture.logging.stdout.StdOutImpl.class);
  }

  public static synchronized void useNoLogging() {
    setImplementation(org.GeekFuture.logging.nologging.NoLoggingImpl.class);
  }
